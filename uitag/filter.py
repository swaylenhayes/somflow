...
COCO_BLOCKLIST: frozenset[str] = frozenset({
    ...
    "mobile phone", "poster", "tablet computer", "human face",
    "computer monitor", "person", "envelope", "window", "human hand",
    "footwear", "television", "swimming pool", "man", "book",
    "picture frame", "clothing", "woman", "laptop", "car", "building",
    "human nose", "land vehicle", "house", "animal", "dog", "cat",
    "tree", "flower", "food", "furniture", "chair", "table", "desk",
    "shelf", "bird", "horse", "drink", "human head", "christmas tree",
    "pumpkin", "stairs", "porch", "cake", "trousers", "rose", "sunflower",
    "wheel", "door", "home appliance", "watch", "pizza", "headphones",
    "bed", "studio couch", "digital clock", "goggles", "clock", "toy",
    "penguin", "marine mammal", "strawberry", "balloon", "boy", "ruler",
    "box",
    # --- Prophylactic COCO classes (not yet observed) ---
    "airplane", "backpack", "baseball bat", "bicycle", "boat", "bottle",
    "bowl", "bus", "cup", "glasses", "handbag", "hat", "kite",
    "motorcycle", "plate", "skateboard", "snowboard", "sports equipment",
    "suitcase", "surfboard", "tennis racket", "tie", "train", "truck",
    "umbrella", "vase", "calendar", "computer keyboard", "office supplies",
    "scoreboard", "vehicle", "whiteboard", "ball",
})
